                ...
                <div className="services" id="services" style={{backgroundColor:theme.secondary}}>
                    ...
                    <div className="services-body">
                        ...
                        <h3 style={{color: theme.primary}}>Technical Skills </h3>
                         C, C++, Python, JAVA, MySQL, MATLAB, HTML, CSS, Java script, Noje.JS, ReactJS, R programming language.
                        </p>
                        <p style={{color:theme.tertiary80}}>
                        <h3 style={{color: theme.primary}}>Tools </h3>
                        VS Code, GNS3, AutoCAD, IBM Rational Software
                        </p>
                        < p style={{color:theme.tertiary80}}>
                        <h3 style={{color: theme.primary}}>Relevant Coursework </h3>
                        DSA, Design and analysis of algorithms, AI, ML, DBMS, OOPs, OS, Cloud Computing, Engineering Drawing, Software Engineering, Computer Networks, Computer architecture and organization, Optimization Techniques, Probability and Statistics
                        </p>
